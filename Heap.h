...
private:
    ...
    int dimensiuneHeap; // nr de elemente existente in heap
    static const int DimensiuneMinima = 10;

    // --- FUNCTIA DE REORDONARE A ELEM --- //
    void Filtrare(int index);

    // --- CALCULARE POZITILE ELEMENTE --- //
    ...
    //--- METODE PENTRU REALOCAREA DINAMICA A STUCTURII --//
...
public:
    ...
    void SorteazaHeap(T* destinatie);
    // --- METODE COADA DE PRIORITATE --- //

    // Insereaza un element in structura
